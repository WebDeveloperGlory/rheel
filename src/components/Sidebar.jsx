...
import { House, Users, Star, Blend, Settings, Power, LayoutGrid, Columns2, SquareChartGantt } from 'lucide-react';
          ...
          <li>
            <Link 
              ...
              className={`menu-item flex py-2 px-5 items-center gap-3 text-[14px] 
                ${location.pathname === '/admins' ? 'bg-[#F3F4F8] text-[#23272E] font-semibold' : 'text-[#8B909A] hover:bg-[#F3F4F8] hover:text-[#23272E]'}`}
            >
              <Settings size={20} />
              <span>Admins</span>
            </Link>
